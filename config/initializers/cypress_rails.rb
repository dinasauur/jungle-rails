...
# The method CypressRails.hooks.before_server_stop will run when we close Cypress. If we forget to clean the database, products will be added everytime we start the test.
